...
// Helper function to get Fees Info data (omitted for brevity, assume this is correct)
...
// --- 2. ENDPOINTS IMPLEMENTATION (omitted T1, T2, T3, T4 for brevity) ---

// ... (Paste working code for T1, T2, T3, T4 here) ...
...
app.get('/enrollment/:id/transaction_history', async (req, res) => {
    try {
        ...
        transactionsSnapshot.forEach(doc => {
            ...
            // LOGGING THE DATA BEFORE PROCESSING (CRITICAL for debugging 500 errors)
        ...
        // Tiyakin na ang error ay nai-log
